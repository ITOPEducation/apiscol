...
<xsl:stylesheet version="1.0" xmlns="http://www.w3.org/1999/xhtml"
	...
	<xsl:variable name="cdn"
		select="'https://rawgit.com/ITOPEducation/apiscol-cdn/master/'" />
	...
	<xsl:template name="gettooltip">
		...
		<xsl:choose>
			...
			<xsl:when
				test="$key='technical.format.http://purl.org/NET/mediatypes/text/html'">
				<xsl:value-of select="'Page web'"></xsl:value-of>
			</xsl:when>
			<xsl:when
				test="$key='technical.format.http://purl.org/NET/mediatypes/text/rtf'">
				<xsl:value-of select="'RTF'"></xsl:value-of>
			</xsl:when>
			<xsl:when
				test="$key='technical.format.http://purl.org/NET/mediatypes/application/vnd.ms-powerpoint'">
				<xsl:value-of select="'PowerPoint
			'"></xsl:value-of>
			</xsl:when>
			<xsl:when
				test="$key='technical.format.http://purl.org/NET/mediatypes/application/pdf'">
				<xsl:value-of select="'PDF'"></xsl:value-of>
			</xsl:when>
			<xsl:when
				test="$key='technical.format.http://purl.org/NET/mediatypes/application/x-uniboard+zip'">
				<xsl:value-of select="'Open Sankoré
			'"></xsl:value-of>
			</xsl:when>
			<xsl:when
				test="$key='technical.format.http://purl.org/NET/mediatypes/image/jpeg'">
				<xsl:value-of select="'Image JPEG
			'"></xsl:value-of>
			</xsl:when>
			<xsl:when
				test="$key='technical.format.http://purl.org/NET/mediatypes/image/gif'">
				<xsl:value-of select="'Image GIF'"></xsl:value-of>
			</xsl:when>
			<xsl:when
				test="$key='technical.format.http://purl.org/NET/mediatypes/image/png'">
				<xsl:value-of select="'Image PNG'"></xsl:value-of>
			</xsl:when>

			<xsl:when
				test="$key='technical.format.http://purl.org/NET/mediatypes/image/bmp'">
				<xsl:value-of select="'Image BMP'"></xsl:value-of>
			</xsl:when>
			<xsl:when
				test="$key='technical.format.http://purl.org/NET/mediatypes/image/tiff'">
				<xsl:value-of select="'Image TIFF'"></xsl:value-of>
			</xsl:when>
			<xsl:when
				test="$key='technical.format.http://purl.org/NET/mediatypes/image/svg'">
				<xsl:value-of select="'Image SVG'"></xsl:value-of>
			</xsl:when>
			<xsl:when
				test="$key='technical.format.http://purl.org/NET/mediatypes/video/flv'">
				<xsl:value-of select="'Video FLV'"></xsl:value-of>
			</xsl:when>
			<xsl:when
				test="$key='technical.format.http://purl.org/NET/mediatypes/video/mpeg'">
				<xsl:value-of select="'Video MPEG'"></xsl:value-of>
			</xsl:when>
			<xsl:when
				test="$key='technical.format.http://purl.org/NET/mediatypes/video/x-ms-asf'">
				<xsl:value-of select="'Video ASF'"></xsl:value-of>
			</xsl:when>
			<xsl:when
				test="$key='technical.format.http://purl.org/NET/mediatypes/video/avi'">
				<xsl:value-of select="'Video AVI'"></xsl:value-of>
			</xsl:when>
			<xsl:when
				test="$key='technical.format.http://purl.org/NET/mediatypes/video/ogv'">
				<xsl:value-of select="'Video OGV'"></xsl:value-of>
			</xsl:when>
			<xsl:when
				test="$key='technical.format.http://purl.org/NET/mediatypes/video/mp4'">
		...
		<xsl:variable name="iconpath">
			...
			'"></xsl:value-of>
				...
				<xsl:when test="$key='educational.intendedEndUserRole.apprenant'">
					...
					<xsl:value-of
						select="'/educational/intendedenduserrole/apprenant.png
			'"></xsl:value-of>
			...
			'"></xsl:value-of>
				...
				<xsl:when
					test="$key='technical.format.http://purl.org/NET/mediatypes/application/x-shockwave-flash'">
					<xsl:value-of
